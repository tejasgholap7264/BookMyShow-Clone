        ...
        <div className="ml-auto pl-3">
          <div className="-mx-1.5 -my-1.5">
            {onRetry && (
              <button
                onClick={onRetry}
                className="inline-flex rounded-md p-1.5 text-red-500 hover:bg-red-100 focus:outline-none focus:ring-2 focus:ring-red-600 focus:ring-offset-2 focus:ring-offset-red-50 mr-2"
              >
